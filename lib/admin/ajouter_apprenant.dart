...
class AjouterApprenant extends StatefulWidget {
  @override
  _AjouterApprenantState createState() => _AjouterApprenantState();
}

class _AjouterApprenantState extends State<AjouterApprenant> {
  ...
  final _defaultImageUrl =
      'https://example.com/defautimage.png'; // URL de l'image par défaut (à adapter)
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Apprenant ajouté avec succès')));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Ajouter Apprenant')),
      body: Padding(
